...
✅ Registro de usuarios con validación de campos y conexión a tabla Cat_Generos  
✅ Inicio de sesión seguro con roles de usuario (administrador / usuario general)  
✅ CRUD completo de actividades inclusivas con auditoría de cambios  
✅ Generación de reportes en PDF y Excel  
✅ Búsqueda y filtrado de actividades por nombre, estado y tipo de discapacidad  
